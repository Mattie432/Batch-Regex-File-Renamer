...
public class UserInterface {
	...
	private void initialize() {
		...
		frmBatchRegexFile.setBounds(100, 100, 512, 314);
		...
		regexFolderPanel.setLayout(new BoxLayout(regexFolderPanel, BoxLayout.Y_AXIS));
		...
		lblNewLabel_1.setBorder(new EmptyBorder(0, 0, 2, 0));
		...
		lblNewLabel_2.setBorder(new EmptyBorder(0, 0, 2, 0));
		panel_5.add(lblNewLabel_2);
		
		JLabel lblString = new JLabel("\"sometext\" : String between quotations");
		lblString.setBorder(new EmptyBorder(0, 0, 2, 0));
		panel_5.add(lblString);
		
		JLabel lbldatecurrTodays = new JLabel("\\date{curr} : Todays date");
		lbldatecurrTodays.setBorder(new EmptyBorder(0, 0, 2, 0));
		panel_5.add(lbldatecurrTodays);
		
		JLabel lbldatecreatedDate = new JLabel("\\date{created} : Date file created");
		lbldatecreatedDate.setBorder(new EmptyBorder(0, 0, 2, 0));
		panel_5.add(lbldatecreatedDate);
		
		JLabel lbldatemodifiedDate = new JLabel("\\date{modified} : Date file modified");
		lbldatemodifiedDate.setBorder(new EmptyBorder(0, 0, 2, 0));
		...
		JLabel lblreplacestrstrReaplace = new JLabel(".replace{str1,str2) : Reaplace occurances");
		lblreplacestrstrReaplace.setBorder(new EmptyBorder(0, 0, 2, 0));
		panel_6.add(lblreplacestrstrReaplace);
		
		JLabel lbltouppercaseChanges = new JLabel(".toUpperCase : Changes to upper case");
		lbltouppercaseChanges.setBorder(new EmptyBorder(0, 0, 2, 0));
		panel_6.add(lbltouppercaseChanges);
		
		JLabel lbltolowercaseChanges = new JLabel(".toLowerCase : Changes to lower case");
		lbltolowercaseChanges.setBorder(new EmptyBorder(0, 0, 2, 0));
		panel_6.add(lbltolowercaseChanges);
		
		JLabel lbltrimRemoves = new JLabel(".trim : Remove leading & trailing spaces");
		lbltrimRemoves.setBorder(new EmptyBorder(0, 0, 2, 0));
		...
		JLabel lblFileExample = new JLabel("root/Subdirectory1/Subdirectory2/Subdirectory3/file.ext");
